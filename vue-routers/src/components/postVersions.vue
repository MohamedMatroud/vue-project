    ...
    <div class="col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <article class="hentry post video">
          ...
          <div class="post-video">
            <div class="video-thumb f-none">
              <img src="../assets/img/post-video.jpg" alt="photo">
      ...
      <div class="ui-block">
        ...
        <article class="hentry post video">
          ...
          <div class="video-player">
            ...
            <img src="../assets/img/video4.jpg" alt="video">
            <div class="video-content">
      ...
      <div class="ui-block">
        ...
        <article class="hentry post has-post-thumbnail">
          ...
          <div class="post-thumb">
            <img src="../assets/img/post__thumb2.jpg" alt="photo">
          </div>
      ...
      <div class="ui-block">
        ...
        <article class="hentry post has-post-thumbnail">
          ...
          <div class="post-thumb">
            <img class="gif-play-image" data-mode="video" data-mp4="videos/post_video.mp4" src="../assets/img/post__thumb3.jpg"  alt="gif">
          </div>
    ...
    <div class="col col-xl-6 col-lg-12 col-md- col-sm-12 col-12">
        ...
        <ul class="comments-list style-2">
          <li class="comment-item">
            <div class="post__author author vcard">
              ...
              <div class="author-date">
                <p><a class="h6 post__author-name fn" href="#">Elaine Dreyfuss</a> Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium der doloremque laudantium.</p>
                <a href="#" class="post-add-icon inline-items">
                  <svg class="olymp-heart-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-heart-icon"></use></svg>
                  <span>8</span>
                </a>
          ...
          <li class="comment-item has-children">
            <div class="post__author author vcard">
              ...
              <div class="author-date">
                <p><a class="h6 post__author-name fn" href="#">Green Goo Rock</a>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugiten, sed quia
                  consequuntur magni dolores eos qui ratione voluptatem sequi en lod nesciunt. Neque porro
                  quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur adipisci velit en lorem ipsum der.</p>
            ...
            <ul class="children">
              <li class="comment-item">
                <div class="post__author author vcard">
                  ...
                  <div class="author-date">
                    <p><a class="h6 post__author-name fn" href="#">Diana Jameson</a> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              ...
              <li class="comment-item">
                <div class="post__author author vcard">
                  ...
                  <div class="author-date">
                    <p><a class="h6 post__author-name fn" href="#">Nicholas Grisom</a> Excepteur sint occaecat cupidatat non proident.</p>
                    <a href="#" class="post-add-icon inline-items">
                      <svg class="olymp-heart-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-heart-icon"></use></svg>
                      <span>0</span>
                    </a>
          ...
          <li class="comment-item">
            <div class="post__author author vcard">
              ...
              <div class="author-date">
                <p><a class="h6 post__author-name fn" href="#">Chris Greyson</a> Dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</p>
      ...
      <div class="ui-block">
        ...
        <article class="hentry post has-post-thumbnail thumb-full-width">
          ...
          <div class="post-thumb">
            <img src="../assets/img/post__thumb4.jpg" alt="photo">
          </div>
      ...
      <div class="ui-block">
        ...
        <article class="hentry post video">
          ...
          <div class="post-video">
            <div class="video-thumb f-none">
              <img src="../assets/img/video6.jpg" alt="photo">
              <a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video">
                <svg class="olymp-play-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-play-icon"></use></svg>
              </a>
            </div>
      ...
      <div class="ui-block">
        ...
        <article class="hentry post">
          ...
          <div class="post-block-photo js-zoom-gallery">
            <a href="../assets/img/post-photo1.jpg" class="half-width"><img src="../assets/img/post-photo1.jpg" alt="photo"></a>
            <a href="../assets/img/post-photo2.jpg" class="half-width"><img src="../assets/img/post-photo2.jpg" alt="photo"></a>
            <a href="../assets/img/post-photo3.jpg" class="col col-3-width"><img src="../assets/img/post-photo3.jpg" alt="photo"></a>
            <a href="../assets/img/post-photo4.jpg" class="col col-3-width"><img src="../assets/img/post-photo4.jpg" alt="photo"></a>
            <a href="../assets/img/post-photo5.jpg" class="more-photos col-3-width">
              <img src="../assets/img/post-photo5.jpg" alt="photo">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <article class="hentry post has-post-thumbnail thumb-full-width">
          ...
          <div class="post-thumb">
            <img src="../assets/img/post__thumb8.jpg" alt="photo">
